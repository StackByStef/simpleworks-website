# SimplWorks Website Build Playbook

**SimplWorks.ai | Cortex Reference Document**
**Created: February 22, 2026**
**Last Updated: February 22, 2026**
**Prototype Project: Top Dog Vending (topdogvending.com)**

---

## Purpose of This Document

This is the master build reference for every website SimplWorks delivers. Cortex reads this document at the start of every new client project. It codifies the complete process — from design standards to deployment — based on the Top Dog Vending build (February 20-21, 2026), which was the first full implementation.

**This document is NOT:**
- The GEO Capability Document (that proves what we can do to clients)
- The dev stack file (that documents SimplWorks.ai's own website)
- A client-facing document

**This document IS:**
- The internal instruction manual for how to build a SimplWorks client website
- The quality standard every site must meet before delivery
- The checklist Cortex follows from strategy call to deployment
...
Every contact form uses the same pattern:
...
form.addEventListener('submit', async (e) => {
  ...
  // Build payload: { name, email, phone, business, message, source }
  // POST to SUPABASE_URL + '/rest/v1/[table_name]'
  // Headers: Content-Type, apikey, Authorization (Bearer), Prefer: return=minimal
...
**Important:** The `source` field identifies which website the lead came from (e.g., `'simplworks-website'`, `'topdogvending'`). This lets us track lead sources in one Supabase table.
...
| Date | Change |
|------|--------|
| Feb 22, 2026 | Created. Based on Top Dog Vending prototype (Feb 20-21, 2026). |

---

*This is an internal Cortex reference document. It is not client-facing. Update it as the process evolves and new patterns are established.*
